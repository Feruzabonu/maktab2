                    ...
                    <div className={styles.info}>
                     <div style={{display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center',marginRight:'30px'}}>
                         ...
                         <div style={{marginLeft:'10px'}}>
                             <p style={{fontSize:'17px',color:'white'}}>Dushanba-juma</p>
                             <p style={{fontSize:'18px',color:'white',fontWeight:'600'}}>8:00 dan 20:00 gacha</p>
                         </div>
                     </div>
                     <div style={{display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center',marginRight:'50px'}}>
                         ...
                         <div style={{marginLeft:'10px'}}>
                             <p style={{fontSize:'17px',color:'white'}}>Qo'ng'iroq qiling</p>
                             <p style={{fontSize:'18px',color:'white',fontWeight:'600'}}>+2 392 3929 210</p>
                         </div>
                     </div>
                    </div>
                    <div className={styles.socialMedia}>
                    <div className={styles.icons} style={{curspor:'pointer',width:'40px',height:'40px',borderRadius:'50%',backgroundColor:'rgba(255,255,255,0.15)',display:'flex',justifyContent:'center',alignItems:'center',marginRight:'5px'}}>
